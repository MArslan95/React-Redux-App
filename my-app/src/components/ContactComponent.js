...
// //in this fuction we use function of function
// //here len is use as parameter here
...
//                                          placeholder="Email" className="form-control" validators={{required,validEmail}} />
...
//                                 <Row className="form-group">
//                                     <Label htmlFor="message" md={2}>Feed Back</Label>
//                                     <Col md={10}>
...
class Contact extends Component {
    ...
    constructor (props) {
        ...
        this.handleSubmit = this.handleSubmit.bind(this);
        // this.handlenputChange = this.handlenputChange.bind(this);
        // this.handleBlur = this.handleBlur.bind(this);
    }

    // handlenputChange(event) {
    ...
    //     errors.telnum = "Tel. Number shold contain only Numbers only";
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) =>this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                <Label htmlFor="feedback" md={2}>Email</Label>
                                <Col md={10}>
